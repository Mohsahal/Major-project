        ...
        <section>
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 mt-4">
            <Feature
              ...
              desc="Create a tailored question bank based on role, experience, and tech stack."
            />
            <Feature
              icon={Mic}
              title="Voice recording"
              desc="Answer verbally with built‑in speech‑to‑text and optional webcam preview."
            />
            <Feature
              icon={Star}
              title="Actionable feedback"
              desc="Receive ratings, strengths, and targeted suggestions to improve quickly."
            />
            <Feature
              icon={MessageCircle}
              title="Answer comparisons"
              desc="Compare your response with an ideal answer to identify gaps."
            />
            <Feature
              icon={Timer}
              title="Efficient practice"
              desc="Short, focused sessions help you build confidence without burnout."
            />
            <Feature
              icon={ShieldCheck}
              title="Secure by design"
              desc="Your session data stays private and under your control."
            />
          </div>
        </section>
          ...
          <div className="grid gap-6 md:grid-cols-2 mt-4">
            <div className="space-y-5">
              <Step
                ...
                desc="Enter the role, description, experience, and tech stack. We’ll generate relevant questions."
              />
              <Step
                num={2}
                title="Record your answers"
                desc="Use the mic (and optional webcam) to answer. Re‑record if needed until satisfied."
              />
              <Step
                num={3}
                title="Review feedback"
                desc="Get a score per question, read the suggested improvements, and compare with the expected answer."
              />
              <Step
                num={4}
                title="Improve and repeat"
                desc="Track progress across sessions and focus on weak areas to level up fast."
              />
            </div>

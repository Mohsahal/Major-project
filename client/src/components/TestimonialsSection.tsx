        ...
        <div className="relative">
          <div className="flex flex-col md:flex-row gap-8">
            {visibleTestimonials.map((testimonial) => (
              <div 
                key={testimonial.id} 
                className="bg-white dark:bg-gray-900 rounded-xl shadow-lg p-6 md:p-8 flex-1 animate-slide-up"
              >
                <div className="flex space-x-1 mb-4">
                  ...
                  {[...Array(5 - testimonial.rating)].map((_, i) => (
                    <Star key={i + testimonial.rating} size={18} className="text-gray-300 dark:text-gray-600" />
                  ))}
                </div>
          ...
          <div className="hidden md:block">
            <Button 
              ...
              variant="outline" 
              onClick={handlePrev}
              className="absolute top-1/2 -translate-y-1/2 -left-4 rounded-full"
            >
            ...
            <Button 
              ...
              variant="outline" 
              onClick={handleNext}
              className="absolute top-1/2 -translate-y-1/2 -right-4 rounded-full"
            >

    ...
    <>
      ...
      <div className="hidden md:block absolute bottom-10 right-10 opacity-70">
        <motion.div
          ...
          className="w-32 h-64 border-2 border-white rounded-3xl relative"
        >
          ...
          <motion.div 
            ...
            className="absolute bottom-8 left-1/2 transform -translate-x-1/2 w-12 h-8 bg-brand-teal rounded"
          ></motion.div>
        </motion.div>
        <motion.div 
          initial={{ opacity: 0 }}
          ...
          className="absolute bottom-0 left-10 h-32 w-16 bg-white rounded-full"
        ></motion.div>
      </div>
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden opacity-10">
        <motion.div 
          ...
          className="absolute top-10 left-10 w-20 h-20 rounded-full border border-white"
        ></motion.div>
        <motion.div 
          animate={{ 
            scale: [1, 1.15, 1],
          ...
          className="absolute bottom-40 left-20 w-32 h-32 rounded-full border border-white"
        ></motion.div>
        <motion.div 
          animate={{ 
            scale: [1, 1.2, 1],
          ...
          className="absolute top-1/4 right-20 w-24 h-24 rounded-full border border-white"
        ></motion.div>
      </div>
    </>
  );
